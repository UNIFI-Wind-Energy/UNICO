------- OpenFAST INPUT FILE ------------------------------------------------
OpenFAST model of the EW16_Thetis_v2_4_0 50kW Reference Wind Turbine, onshore version 1.00
---------------------- SIMULATION CONTROL --------------------------------------
...
---------------------- INPUT FILES ---------------------------------------------
"ED_files/ED_ws12_ti13-0_s112_y0_i0.dat"	                  EDFile	      -	Name	of	file	containing	ElastoDyn	input	parameters	(quoted	string)
"unused"                                                      BDBldFile(1)    - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
"unused"                                                      BDBldFile(2)    - Name of file containing BeamDyn input parameters for blade 2 (quoted string)
"unused"                                                      BDBldFile(3)    - Name of file containing BeamDyn input parameters for blade 3 (quoted string)
"IF_files/IF_ws12_ti13-0_s112_y0_i-8.dat"	                  InflowFile	  -	Name	of	file	containing	inflow	wind	input	parameters	(quoted	string)
"../TurbineFiles/AD_files/AD15_UNIFI_50kW_SRWT.dat"           AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
"../TurbineFiles/SD_files/SD_UNIFI_50kW_SRWT_UNICO_SL.dat"    ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
