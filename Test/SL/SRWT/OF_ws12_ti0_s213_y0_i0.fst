------- OpenFAST INPUT FILE ------------------------------------------------
OpenFAST model of the UNIFI 50kW Reference SWT.
---------------------- SIMULATION CONTROL --------------------------------------
True          Echo            - Echo input data to <RootName>.ech (flag)
"FATAL"       AbortLevel      - Error level when simulation should abort (string) {"WARNING", "SEVERE", "FATAL"}
        720   TMax            - Total run time (s)
...
---------------------- INPUT FILES ---------------------------------------------
"ED_files/ED_ws12_ti0_s213_y0_i0.dat"	EDFile	- Name	of	file	containing	ElastoDyn	input	parameters(quoted	string)
"unused"    BDBldFile(1)    - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
"unused"    BDBldFile(2)    - Name of file containing BeamDyn input parameters for blade 2 (quoted string)
"unused"    BDBldFile(3)    - Name of file containing BeamDyn input parameters for blade 3 (quoted string)
"IF_files/IF_ws12_ti0_s213_y0_i0.dat"	InflowFile	- Name	of	file	containing	inflow	wind	input	parameters	(quoted	string)
"AD_files/UNIFI_50kW_Reference_SWT_ADyn15OF.dat"       AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
"SD_files/UNIFI_50kW_Reference_SWT_ServoDyn.dat"    ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
