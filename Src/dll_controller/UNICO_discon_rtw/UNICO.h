...
#ifndef RTW_HEADER_UNICO_h_
#define RTW_HEADER_UNICO_h_
#ifndef UNICO_COMMON_INCLUDES_
#define UNICO_COMMON_INCLUDES_
#include <stdio.h>
#include "rtwtypes.h"
#include "simstruc.h"
#include "fixedpoint.h"
#include "rt_logging.h"
#endif                                 /* UNICO_COMMON_INCLUDES_ */
...
#define UNICO_rtModel                  RT_MODEL_UNICO_T
...
typedef struct {
  real_T Rated_Speed;                  /* '<Root>/Rated_Speed' */
  real_T Mode_Gain;                    /* '<Root>/Mode_Gain' */
  real_T Blade1_OP_Root_Moment;        /* '<Root>/Blade1_OP_Root_Moment' */
  real_T Blade2_OP_Root_Moment;        /* '<Root>/Blade2_OP_Root_Moment' */
  real_T Blade3_OP_Root_Moment;        /* '<Root>/Blade3_OP_Root_Moment' */
  real_T Rotor_Azimuth_Angle;          /* '<Root>/Rotor_Azimuth_Angle' */
  real_T Init;                         /* '<Root>/Init' */
  real_T Shaft_Torque;                 /* '<Root>/Shaft_Torque' */
  real_T Blade1_IP_Root_Moment;        /* '<Root>/Blade1_IP_Root_Moment' */
  real_T Blade2_IP_Root_Moment;        /* '<Root>/Blade2_IP_Root_Moment' */
  real_T Blade3_IP_Root_Moment;        /* '<Root>/Blade3_IP_Root_Moment' */
  real_T YawError;                     /* '<Root>/YawError' */
  real_T YawBearingRate;               /* '<Root>/YawBearingRate' */
  real_T ElectricalPower;              /* '<Root>/ElectricalPower' */
  real_T Fore_Aft_Tower_Accel;         /* '<Root>/Fore_Aft_Tower_Accel' */
  real_T Generator_Speed;              /* '<Root>/Generator_Speed' */
  real_T Measured_Pitch;               /* '<Root>/Measured_Pitch' */
  real_T Sidewards_Tower_Accel;        /* '<Root>/Sidewards_Tower_Accel' */
  real_T Below_Rated_Pitch_Angle;      /* '<Root>/Below_Rated_Pitch_Angle' */
  real_T Wind_Speed;                   /* '<Root>/Wind_Speed' */
  real_T Com_dt;                       /* '<Root>/Com_dt' */
  real_T SimTime;                      /* '<Root>/SimTime' */
  real_T dKSwitch;                     /* '<Root>/dKSwitch' */
  real_T dRgn2K;                       /* '<Root>/dRgn2K' */
  real_T dOMSpdSwitch;                 /* '<Root>/dOMSpdSwitch' */
  char_T dTablePath[256];              /* '<Root>/dTablePath' */
  real_T dRotorRadius;                 /* '<Root>/dRotorRadius' */
  real_T dRgn3Mode;                    /* '<Root>/dRgn3Mode' */
  real_T dMRgn3Lin;                    /* '<Root>/dMRgn3Lin' */
  real_T dGenEff;                      /* '<Root>/dGenEff' */
  real_T dMinOMSpd;                    /* '<Root>/dMinOMSpd' */
  real_T dRtWSpd;                      /* '<Root>/dRtWSpd' */
  real_T dRhoAir;                      /* '<Root>/dRhoAir' */
  real_T dRtPwr;                       /* '<Root>/dRtPwr' */
  real_T dRtGenSpd;                    /* '<Root>/dRtGenSpd' */
  real_T dTSRopt;                      /* '<Root>/dTSRopt' */
  real_T dRgn2Mode;                    /* '<Root>/dRgn2Mode' */
  real_T dWindSpeedFSw;                /* '<Root>/dWindSpeedFSw' */
  real_T dWindSpeedFLPF;               /* '<Root>/dWindSpeedFLPF' */
  real_T dGenSpeedFSw;                 /* '<Root>/dGenSpeedFSw' */
  real_T dGenSpeedFLPF;                /* '<Root>/dGenSpeedFLPF' */
  real_T dRefSpeedFSw;                 /* '<Root>/dRefSpeedFSw' */
  real_T dRefSpeedFLPF;                /* '<Root>/dRefSpeedFLPF' */
  real_T dVLin;                        /* '<Root>/dVLin' */
  real_T dMaxRat;                      /* '<Root>/dMaxRat' */
...
typedef struct {
  ...
  real_T Log7;                         /* '<Root>/Log7' */
  real_T Log10;                        /* '<Root>/Log10' */
  real_T Log8;                         /* '<Root>/Log8' */
  real_T Log20;                        /* '<Root>/Log20' */
  real_T Log12;                        /* '<Root>/Log12' */
  real_T Log17;                        /* '<Root>/Log17' */
  real_T Log18;                        /* '<Root>/Log18' */
  real_T Log19;                        /* '<Root>/Log19' */
  real_T Log13;                        /* '<Root>/Log13' */
  real_T Log14;                        /* '<Root>/Log14' */
  real_T Log15;                        /* '<Root>/Log15' */
  real_T Log1;                         /* '<Root>/Log1' */
  real_T Log16;                        /* '<Root>/Log16' */
  real_T Log2;                         /* '<Root>/Log2' */
  real_T Log9;                         /* '<Root>/Log9' */
  real_T Log11;                        /* '<Root>/Log11' */
  real_T Yaw_Rate;                     /* '<Root>/Yaw_Rate' */
  real_T Generator_Torque;             /* '<Root>/Generator_Torque' */
  real_T Blade1_Pitch_Angle;           /* '<Root>/Blade1_Pitch_Angle' */
  real_T Blade2_Pitch_Angle;           /* '<Root>/Blade2_Pitch_Angle' */
  real_T Blade3_Pitch_Angle;           /* '<Root>/Blade3_Pitch_Angle' */
  real_T Collective_Pitch_Angle;       /* '<Root>/Collective_Pitch_Angle' */
} ExtY_UNICO_T;

/* Backward compatible GRT Identifiers */
#define rtB                            UNICO_B
#define BlockIO                        B_UNICO_T
#define rtU                            UNICO_U
#define ExternalInputs                 ExtU_UNICO_T
#define rtY                            UNICO_Y
#define ExternalOutputs                ExtY_UNICO_T
#define rtDWork                        UNICO_DW
#define D_Work                         DW_UNICO_T

/* Real-time Model Data Structure */
struct tag_RTM_UNICO_T {
  const char_T *path;
...
/* Block signals (default storage) */
extern B_UNICO_T UNICO_B;

/* Block states (default storage) */
extern DW_UNICO_T UNICO_DW;

/* External inputs (root inport signals with default storage) */
extern ExtU_UNICO_T UNICO_U;

/* External outputs (root outports fed by signals with default storage) */
extern ExtY_UNICO_T UNICO_Y;

/*====================*
 * External functions *
 *====================*/
extern UNICO_rtModel *UNICO(void);
...
extern RT_MODEL_UNICO_T *const UNICO_M;
 ...
 * '<S17>'  : 'UNICO/UNICO CONTROLLER/Extract Signals1/Discrete Varying Lowpass/FOS'
